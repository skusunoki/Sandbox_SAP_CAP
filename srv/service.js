...
exports.RevenueRecognitionImpl = exports.ProductImpl = exports.ContractImpl = exports.TableModule = exports.Contracts = void 0;
...
function getData(_req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let contract of dataset.Contracts) {
            ...
            let revenueRecognitions = dataset.RevenueRecognitions.filter((r) => r.contract_ID === contract.ID);
            recordset.push({
                ID: contract.ID,
                contracts: [contract],
                products: [product],
